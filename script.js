document.addEventListener('DOMContentLoaded', () => {
    ...
    const PRODUCTS = [
        {
            ...
            images: ["images/MAG 3 RECTOFULL.webp", "MAG 3 VERSOFULL.webp", "MAG 3 LIFESTYLEFULL.webp"],
        ...
        },
        {
            ...
            images: ["images/MAG 2 RECTOFULL.webp", "MAG 2 VERSOFULL.webp", "MAG 2 LIFESTYLE.gif"],
        ...
        },
        {
            ...
            images: ["images/MAG 1 RECTOFULL.webp", "MAG 1 VERSOFULL.webp", "MAG 1 LIFESTYLEFULL.webp"],
            stockLimit: 6,
        ...
        },
        {
            ...
            images: ["images/TOTE BAG RECTOFULL.webp", "TOTE BAG VERSOFULL.webp", "images/TOTE LIFESTYLE.gif"],
            summary: null
        }
    ];
    ...
    const renderCartPage = (cart) => {
        ...
        cart.forEach(item => {
            ...
            grandTotal += subtotal;
            // On remplace FULL ou MID par THUMB pour l'affichage panier
            const thumbImage = product.images[0].replace('FULL', 'THUMB').replace('MID', 'THUMB');
            html += `
                <div class="cart-item">
                    <div class="item-grid">
                        <img src="${thumbImage}" class="item-img" alt="${product.title}">
                        <div class="item-top">
                            <div class="item-info">
